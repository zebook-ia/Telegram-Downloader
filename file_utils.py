...
def write_download_log(log_file_path: str, filename: str, media_type: str, 
                      message_id: int, message_date, topic_name: str = None) -> None:
    """
    ...
    log_entry = (f"{datetime.now()}: {filename} - {media_type} - "
